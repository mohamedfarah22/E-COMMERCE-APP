...
const handlerWrapperArgs = { functionName: 'ecomm-app-api-dev-logOutUserLambda', timeout: 6 };

try {
  const userHandler = require('./handlers/auth.js');
  module.exports.handler = serverlessSDK.handler(userHandler.logOut, handlerWrapperArgs);
} catch (error) {
