...
const handlerWrapperArgs = { functionName: 'ecomm-app-api-dev-registerUserLambda', timeout: 6 };

try {
  const userHandler = require('./handlers/auth.js');
  module.exports.handler = serverlessSDK.handler(userHandler.registerUser, handlerWrapperArgs);
} catch (error) {
